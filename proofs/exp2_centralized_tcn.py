...
# --- CONFIGURATION ---
EXPERIMENT_NAME = "Exp2: Centralized TCN"
...
def run_experiment():
    ...
    # Model Setup (TCN requires num_channels)
    ...
    pd.DataFrame([metrics]).to_csv(os.path.join(BASE_DIR, f"proofs/results/metrics_exp2.csv"), index=False)
    print(f"\nProof saved to proofs/results/metrics_exp2.csv")
